...
<html lang="en">
    ...
    <center>
        <div style="width: 1200px;height: 600px;overflow: scroll;border: 2px solid black;background-color: lightcyan;">
            <h2>Student List</h2>
            <table width="1100" border="1" cellspacing="0" cellpadding="10">
                <tr bgcolor="cyan"><th>E Mail</th><th>Student Name</th><th>Qualification</th><th>DOB</th><th>Gender</th>
                    <th>Address</th><th>City</th><th>State</th><th>Pin</th><th>Contact</th></tr>
                        <%
                            DBCon db = new DBCon();
