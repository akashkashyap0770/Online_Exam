...
<center>
    <div style="width: 800; height: 600px; border: 2px solid black; background-color: lightcyan">
        <h2>Add Question</h2>
        <form action="UpdateQues">
            <%
             ...
             {   
            %>
        <table width="500" height="400" border="1" cellspacing="0" cellpadding="10">
            ...
            <tr><td>Question1</td><td><input type="text" name="opt1" style="width: 200px;" value="<%=db.rst.getString(3)%>"></td></tr>
            <tr><td>Question2</td><td><input type="text" name="opt2" style="width: 200px;" value="<%=db.rst.getString(4)%>"></td></tr>
            <tr><td>Question3</td><td><input type="text" name="opt3" style="width: 200px;" value="<%=db.rst.getString(5)%>"></td></tr>
            <tr><td>Question4</td><td><input type="text" name="opt4" style="width: 200px;" value="<%=db.rst.getString(6)%>"></td></tr>
